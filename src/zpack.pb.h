...
class ZPack : public ::google::protobuf::Message {
 public:
  ...
  static const int kNewvalFieldNumber = 7;
  ...
  static const int kValnullFieldNumber = 9;
  ...
  static const int kNewvalnullFieldNumber = 10;
  ...
  static const int kReplicanumFieldNumber = 11;
