...
//oht: my send for test
bool TCPProxy::mysend(const void *sendbuf, const size_t sendcount,
		void *recvbuf, size_t &recvcount) {
...
//oht: client creates a server socket
int TCPProxy::makeSvrSocket() { //only for svr
