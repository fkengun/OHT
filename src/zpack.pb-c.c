...
{
  {
    ...
    PROTOBUF_C_OFFSETOF(ZPack, has_client_ip),
    PROTOBUF_C_OFFSETOF(ZPack, client_ip),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(ZPack, has_client_port),
    PROTOBUF_C_OFFSETOF(ZPack, client_port),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned zpack__field_indices_by_name[] = {
  0,   /* field[0] = client_ip */
  1,   /* field[1] = client_port */
  4,   /* field[4] = key */
  7,   /* field[7] = lease */
  6,   /* field[6] = newval */
  9,   /* field[9] = newvalnull */
  3,   /* field[3] = opcode */
  10,   /* field[10] = replicanum */
  2,   /* field[2] = seq_num */
  5,   /* field[5] = val */
  8,   /* field[8] = valnull */
};
